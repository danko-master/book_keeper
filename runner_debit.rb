...
# Run: export APP_ENV=production && bundle exec sidekiq -d -C ./config/sidekiq.yml -r ./runner_debit.rb --logfile log/bk_debit_production.log --pidfile tmp/sidekiq_debit.pid
